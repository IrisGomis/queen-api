                ...
                <div className="row tarjetas-spreads">
                    <div className="col-xl-4 col-lg-4 col-md-6 has-animation">
                        <div className="imagen">
                            <img src={P1} alt="image wear" className="img" />
                        </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 has-animation" data-delay="50">
                        <div className="imagen">
                         <img src={P2} alt="image wash" className="img"/>
                        </div>
                        <div className="content">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 has-animation" data-delay="100">
                        <div className="imagen">
                         <img src={P3} alt="image keep" className="img"/>
                        </div>
                        <div className="content">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 has-animation" data-delay="150">
                        <div className="imagen">
                          <img src={P4} alt="image wear" className="img"/>
                        </div>
                        <div className="content">
                        <h4 className="mb-4">Wear Facemask</h4>
                        <p className="mb-0">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 has-animation" data-delay="200">
                        <div className="imagen">
                          <img src={P5} alt="image hangs" className="img"/>
                        </div>
                        <div className="content">
                            <h4 className="mb-4">Wash your hangs often</h4>
                            <p className="mb-0">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 has-animation" data-delay="250">
                        <div className="imagen">
                        <img src={P6} alt="image keep" className="img"/>
                        </div>
                        <div className="content">
                        <h4 className="mb-4">Keep social distance</h4>
                        <p className="mb-0">
